...
void TitleScene::Draw()
{
	...
	DrawGraph(0, 0, im.ImageIdReturn("仮image/title/TitleImage.png", SCENE_SELECT), true);
	...
	if (selectFlag == true) {
		...
		DrawGraph(70,410,im.ImageIdReturn("仮image/title/TitleBoard.png",SCENE_SELECT),true);

		DrawGraph(250, 450, im.ImageIdReturn("仮image/title/TitleSelectSpell.png", SCENE_SELECT), true);
		...
		DrawGraph(250, 530, im.ImageIdReturn("仮image/title/TitleSousaSpell.png", SCENE_SELECT), true);
		if (_menu == GAME_START) {
			dirMoveCnt += 2;
			DrawGraph(170 - abs(30 - ( 200 + (dirMoveCnt / 2 % 60)) % 59), 445, im.ImageIdReturn("仮image/yazirushi.png", SCENE_SELECT), true);
		}
		else if (_menu == GAME_EXPLAIN) {
			dirMoveCnt += 2;
			DrawGraph(170 - abs(30 - (200 + (dirMoveCnt / 2 % 60)) % 59), 525, im.ImageIdReturn("仮image/yazirushi.png", SCENE_SELECT), true);
		}
	}
	if (operateFlag == true) {
	...
	DrawExtendGraph(10, 10,750,450, im.ImageIdReturn("仮image/title.png", SCENE_SELECT), true);
