...
void GameScene::DrawBack(Position2 offset)
{
	...
	DrawGraph(0 - offset.x*1.5f, 0 - offset.y, im.ImageIdReturn("仮image/Game/back2.png", SCENE_RESULT), true);
	DrawGraph(0 - offset.x*2.f, 0 - offset.y, im.ImageIdReturn("仮image/Game/back1.png", SCENE_RESULT), true);
