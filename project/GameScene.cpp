...
void GameScene::DrawBack()
{
	//まだ多重スクロールはしないです
	ImageMgr& im = ImageMgr::Instance();
	DrawGraph(0,0,im.ImageIdReturn("仮image/Game/backOmage.png",SCENE_RESULT),true);
	DrawGraph(0, 0, im.ImageIdReturn("仮image/Game/back3.png", SCENE_RESULT), true);
	DrawGraph(0, 0, im.ImageIdReturn("仮image/Game/back2.png.png", SCENE_RESULT), true);
	DrawGraph(0, 0, im.ImageIdReturn("仮image/Game/back1.png", SCENE_RESULT), true);
